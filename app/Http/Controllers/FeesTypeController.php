...
use App\Imports\FeesTypeImport;
use App\Imports\ImportFeesType;
use Throwable;
use Carbon\Carbon;
use Dompdf\Dompdf;
...
class FeesTypeController extends Controller
{
     ...
     */
     ...
     public function import(Request $request){
       Excel::import(new FeesTypeImport, $request->file('file'));
       return view('fees.fees_types');
    }
     public function createBulkData(Request $request){
