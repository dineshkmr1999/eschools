...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                {{ __('manage') . ' ' . __('student_late_entry') }}
            </h3>
        </div>
            ...
            @if (Auth::user()->can('student-lateentry-create'))
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">
                                {{ __('create') . ' ' . __('student_late_entry') }}
                            </h4>
                            <form class="create-form pt-3" id="formdata" action="{{ url('student-lateentry') }}"
                                method="POST" novalidate="novalidate">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label>{{ __('reason') }} <span class="text-danger">*</span></label>
                                        {!! Form::text('reason', null, ['required', 'placeholder' => __('reason'), 'class' => 'form-control']) !!}
                                        <span class="input-group-addon input-group-append">
                                        </span>
                                    </div>
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label>{{ __('entry_time') }} <span class="text-danger">*</span></label>
                                        {!! Form::text('entry_time', null, [
                                            'required',
                                            'placeholder' => 'HH:MM',
                                            'type' => 'time',
                                            'class' => 'form-control',
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-12">
                                        <label>{{ __('student_id') }}</label>
                                        {!! Form::number('student_id', null, [
                                            'rows' => '2',
            ...
            @if (Auth::user()->can('student-lateentry-list'))
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">
                                {{ __('list') . ' ' . __('student_late_entry') }}
                            </h4>
                            <div class="row">
                                <div class="col-12">
                                    <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                        data-url="{{ url('student-lateentry-list') }}" data-click-to-select="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-field="student_id" data-sortable="false">
                                                    {{ __('student_id') }}</th>
                                                @if (Auth::user()->can('student-lateentry-edit') || Auth::user()->can('student-lateentry-delete'))
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> {{ __('edit') . ' ' . __('student_late_entry') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fa fa-close"></i></span>
                    </button>
                </div>
                <form id="formdata" class="editform" action="{{ url('student-lateentry') }}" novalidate="novalidate">
                    @csrf
