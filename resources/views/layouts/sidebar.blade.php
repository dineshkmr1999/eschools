...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        @hasrole('Human Resource Management')
            {{-- dashboard --}}
            @canany(['teacher-data', 'teacher-list', 'teacher-create', 'teacher-edit', 'teacher-delete', 'holiday-list',
                ...
                <div class="collapse" id="academics-menu">
                        ...
                        @can('teacher-create')
                            <li class="nav-item">
                                <a href="{{ route('teachers.index') }}" class="nav-link"> <span
                                        class="menu-title">{{ __('teacher') }}</span> <i class="fa fa-user menu-icon"></i>
                                    {{ __('Teachers_manage') }}
                                </a>
                            </li>
                        @endcan
                    ...
                    <ul class="nav flex-column sub-menu">
                        @can('teacher-create')ghrmmmm
                            <li class="nav-item">
                                <a href="{{ route('teachers') }}" class="nav-link"> <span
        ...
        @can('manage-expenses')
            <li class="nav-item">
                <a href="{{ route('expense.index') }}" class="nav-link"> <span
                        class="menu-title">{{ __('Expenses') }}</span> <i class="fa fa-money menu-icon"></i> </a>
            </li>
        @endcan
        ...
        @hasrole('Super Admin')
            {{-- admission --}}
            @canany(['manage-enquiry-mode-create', 'manage-enquiry-mode-list', 'admission-enquiry-create',
                'admission-enquiry-list'])
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#admission-menu" aria-expanded="false"
                        aria-controls="admission-menu"> <span class="menu-title">{{ __('admission') }}</span> <i
                            class="fa fa-university menu-icon"></i> </a>
                    <div class="collapse" id="admission-menu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @can('admission-enquiry-list')
                                <li class="nav-item">
                                    <a href="{{ route('admissionenquiry.index') }}" class="nav-link">
                                        {{ __('admission_enquire') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="fees-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        {{-- @can('fees-paid')
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fees-type.create-bulk-data') }}"> {{__('fees')}} {{ __('bulkData') }} {{__('')}}
                        </a>
                    </li>
                    @endcan --}}
                        {{-- @can('fees-paid')
