<?php $__env->startSection('title'); ?>
    <?php echo e(__('admission_enquire')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                <?php echo e(__('manage') . ' ' . __('admission_enquire')); ?>

            </h3>
        </div>

        <div class="row">
            <?php if(Auth::user()->can('admission-enquiry-create')): ?>
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">
                                <?php echo e(__('create') . ' ' . __('admission_enquire')); ?>

                            </h4>
                            <form class="create-form pt-3" id="formdata" action="<?php echo e(url('admissionenquiry')); ?>"
                                method="POST" novalidate="novalidate">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label><?php echo e(__('admission_number')); ?> <span class="text-danger">*</span></label>
                                        <?php echo Form::text('admission_number', null, [
                                            'required',
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label><?php echo e(__('student_name')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <?php echo Form::text('student_dob', null, [
                                            'required',
                                            'placeholder' => __('dob'),
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label><?php echo e(__('added_by')); ?> <span class="text-danger">*</span></label>
                                        <?php echo Form::text('added_by', null, [
                                            'required',
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label><?php echo e(__('enquiry_date')); ?> <span class="text-danger">*</span></label>
                                        <?php echo Form::text('enquiry_date', null, [
                                            'required',
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label><?php echo e(__('Enquiry Mode')); ?> <span class="text-danger">*</span></label>
                                        <select id="enquiryModeSelect" class="form-control">
                                            <option value="">Select Enquiry Mode</option>
                                        </select>
                                        <?php echo Form::hidden('enquiry_mode_id', null, ['id' => 'selectedEnquiryModeId']); ?>

                                    </div>
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label><?php echo e(__('previous_school')); ?> <span class="text-danger">*</span></label>
                                        <?php echo Form::text('previous_school', null, [
                                            'required',
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label><?php echo e(__('parent_name')); ?> <span class="text-danger">*</span></label>
                                        <?php echo Form::text('parent_name', null, [
                                            'required',
            ...
            <?php if(Auth::user()->can('manage-enquiry-mode-list')): ?>
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">
                                <?php echo e(__('list') . ' ' . __('admission_enquire')); ?>

                            </h4>
                            <div class="row">
                                <div class="col-12">
                                    <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                        data-url="<?php echo e(url('admissionenquiry-list')); ?>" data-click-to-select="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-field="admission_number" data-sortable="false">
                                                    <?php echo e(__('admission_number')); ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('edit_admission_enquiry')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fa fa-close"></i></span>
                    </button>
                </div>
                <form id="editdata" class="editform" action="<?php echo e(url('admissionenquiry')); ?>" novalidate="novalidate"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="form-group col-sm-12 col-md-6">
                                <label><?php echo e(__('student_dob')); ?> <span class="text-danger">*</span></label>
                                <?php echo Form::text('student_dob', null, [
                                    'required',
                        ...
                        <div class="row form-group">
                            ...
                            <div class="form-group col-sm-12 col-md-6">
                                <label><?php echo e(__('class_applying_for')); ?> <span class="text-danger">*</span></label>
                                <?php echo Form::text('class', null, [
                                    'required',
                        ...
                        <div class="row form-group">
                            <div class="form-group col-sm-12 col-md-6">
                                ...
                                <?php echo Form::hidden('enquiry_mode', null, ['id' => 'editSelectedEnquiryModeId']); ?>
                        ...
                        <div class="row form-group">
                            <div class="form-group col-sm-12 col-md-6">
                                ...
                                <div class="d-flex">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <?php echo Form::radio('gender', 'male', null, ['class' => 'form-check-input edit', 'id' => 'editmaleGender']); ?>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <?php echo Form::radio('gender', 'female', null, ['class' => 'form-check-input edit', 'id' => 'editfemaleGender']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dineshkumar/Desktop/eschools1234/resources/views/admission_enquire/index.blade.php ENDPATH**/ ?>