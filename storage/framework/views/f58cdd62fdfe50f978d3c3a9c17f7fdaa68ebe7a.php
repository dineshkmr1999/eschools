<?php $__env->startSection('title'); ?>
    <?php echo e(__(' Human Resource dashboard')); ?>
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4) {
                    if (xhr.status === 200) {
                        ...
                        xhr2.open('GET', "<?php echo e(asset('/teacher-management')); ?>", true);
...
<?php echo $__env->make('layouts.human_resource_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocss\htdocs\eschool19-09\escool123\resources\views/human_resource/dashboard.blade.php ENDPATH**/ ?>