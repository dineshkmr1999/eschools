...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('teacher-create')): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('students.create-bulk-data-super-admin')); ?>" class="nav-link"> <span
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('teacher-create')): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('teacher.create-bulk-data-super-admin')); ?>" class="nav-link"> <span
...
<?php /**PATH C:\xampp\htdocss\htdocs\eschool19-09\escool123\resources\views/layouts/super_admin.blade.php ENDPATH**/ ?>